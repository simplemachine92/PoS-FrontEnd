...
export default function Quotes() {
  return (
    <div className="container px-5 py-6 mx-auto flex items-center justify-center">
      <img clasName="absolute -bottom-0 -right-12" src="assets/eth_circle_3.svg" alt="Eth Circle" />
      <img clasName="items-center justify-center -mr-32" src="assets/ChatText.svg" alt="Chat Message" />
