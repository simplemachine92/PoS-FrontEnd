...
export default function BottomLinks({}) {
  return (
    <div className="container px-5 py-6 mx-auto flex items-center justify-center">
      ...
      >
        <img src={"/image/gitcoindao_sign.svg"} className="h-16" alt="gitcoinDAO" />
        <span style={{ color: "#fb5c37" }} className="text-white pl-5">
          &
        </span>{" "}
      </a>
      <a
        ...
        className="flex title-font font-medium items-center justify-center text-gray-900"
      >
        <img src={"/image/logo-moon-stake.svg"} className="h-16 pl-5" alt="gitcoinDAO" />
      </a>
