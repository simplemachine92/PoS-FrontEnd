      ...
      <div className="flex flex-wrap w-1/2 justify-center bg-no-repeat">
        <div className="max-w-lg py-5">
          ...
          <a href="/order" rel="noreferrer">
            <button
              className="w-3/5 sm:w-3/5 md:w-7/12 mt-4 py-1 sm:py-4 text-2xs sm:text-xl bg-gradient-to-r from-yellow-300 to-yellow-pos hover:from-yellow-pos hover:to-yellow-poslight text-gray-900 font-bold rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out"
