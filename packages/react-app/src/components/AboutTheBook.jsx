    ...
    <>
      <div className="bg-midpage bg-right bg-contain sm:bg-fit bg-no-repeat">
        <div className="container px-5 mb-1 pt-3 md:pb-2 md:pt-5 mx-auto font-spacemono">
          <h6 className="text-yellow-pos font-bold text-lg">Get it signed, support public goods</h6>
          <h3 className="text-sm mb-5 sm:text-md md:text-lg">
      ...
      <div className="mx-auto font-spacemono bg-circle bg-left bg-6 sm:bg-contain bg-no-repeat">
        <div className="container px-5 mx-auto">
          <h3 className="text-left text-sm mb-5 sm:text-md md:text-lg">
          ...
          <h6 className="text-yellow-pos font-bold text-2xl mb-5">About the book</h6>

          <h3 className="text-left text-sm sm:text-md md:text-lg">
