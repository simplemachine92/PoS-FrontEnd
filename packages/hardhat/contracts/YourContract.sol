    ...
    function generateSVG(uint256 id) private view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                '<tspan x="0" y="57.6">"pledge": ',
                tokens[id].sigValue,
                ' ETH,</tspan><tspan x="0" y="86.4" xml:space="preserve">"recipient": ',
                tokens[id].recipient,
                ',</tspan><tspan x="0" y="115.2">"version": 0,</tspan><tspan x="0" y="144">},</tspan><tspan x="0" y="201.6">"msg": ',
