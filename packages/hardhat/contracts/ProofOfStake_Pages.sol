    ...
    function generateSVG(uint256 id) private view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                '<text transform="translate(75 352.85)" font-size="16" font-family="ArialMT, Arial">{<tspan x="0" y="28.8">"signer": vitalik.eth,</tspan>',
                ...
                tokens[id].sigValue,
                ' wei,</tspan><tspan x="0" y="144">"version": 0,</tspan><tspan x="0" y="172.8">},</tspan><tspan x="0" y="230.4">"msg": ',
